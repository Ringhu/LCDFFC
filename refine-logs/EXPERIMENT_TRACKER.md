...
| Q203 | M2 | main pivot method | GRU + replay-calibrated prior + `qp_carbon` | train/val/test | high-prior-cell MAE / overall MAE / cost / carbon / peak | MUST | RUNNING | Launched on local GPU 2 with replay_prior_qp_carbon labels and seed 42 |
